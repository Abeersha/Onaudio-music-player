...
import 'package:audio3/openplayer.dart';
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    onTap: () async {
                      ...
                      int currentIndex = allSongs.indexWhere(
                          (element) => element.id == searchSongItem[index].id);

                      await OpenMusic(
                        fullSongs: [],
                        index: currentIndex,
                      ).openAssetPlayer(
                          index: currentIndex, songs: searchAudio);
